    ...
    templates: {
      ...
      userList: function(member) {
        ...
        if(member.color !== undefined) {
          html += ' <p><a href="/admin/' + member.id + '" target="_blank" style="color: ' + member.color + ';">' + member.name + '</a></p>';
        }
        else {
          html += ' <p><a href="/admin/' + member.id + '" target="_blank">' + member.name + '</a></p>';
        }
        html += '</div>';
        return html;
      }
